...
class DrumsDemoVC : UIViewController, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func etToggle(sender: AnyObject) {
        ...
        SVProgressHUD.showImage(UIImage(named: "ExpressyIcon"), status: self.bassDrumBtn.gestureRecognizers!.first!.enabled ? "Expressive Touch Enabled" : "Expressive Touch Disabled")
    }
